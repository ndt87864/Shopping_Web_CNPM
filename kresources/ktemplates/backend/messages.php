...
if (isset($_POST['ad_submit_msg'])) {
    if (!empty($_POST['msg'])) {
        ...
        if (!$result) {
            ...
            redirect("index.php?messages&message_id=$other_user_id ");
        }
    }
}
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)):
                        ...
                        <?php } elseif ($row['sender_id'] == $other_user_id) { ?>
                            ...
                            <div class="direct-chat-msg left">
                                <div class="direct-chat-info clearfix">
                                    <span class="direct-chat-name pull-left">Người dùng:
                                        <?php echo $user_name; ?>
                                    </span>
                                </div>
                                <img class="direct-chat-img" src="../../kresources/uploads/<?php echo $user_photo2 ?>"
                                    alt="message user image">
                                <div class="direct-chat-text">
                                    <?php echo $row['msg']; ?>
                                </div><br>
        ...
        <div class="box-footer">
            <form action="#" method="post" enctype="multipart/form-data">
                <div class="flex-container">
                    ...
                    <button type="submit" name="ad_submit_msg" style="">
